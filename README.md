...
* 1 [定义](protocol.md#定义)
  * 1.1 [数据类型](protocol.md#数据类型)
  * 1.2 [坐标](protocol.md#坐标)
  * 1.3 [定点小数](protocol.md#定点小数)
  * 1.4 [协议版本](protocol.md#协议版本)
  * 1.5 [其他定义](protocol.md#其他定义)
* 2 [数据包格式](protocol.md#数据包格式)
  * 2.1 [未压缩的封包](protocol.md#未压缩的封包)
  * 2.2 [压缩的封包](protocol.md#压缩的封包)
* 3 [握手](protocol.md#握手)
  * 3.1 [服务端](protocol.md#服务端)
    * 3.1.1 [握手](protocol.md#握手-1)
* 4 [游戏中](protocol.md#游戏中)
  * 4.1 [客户端](protocol.md#客户端)
    * 4.1.1 [保持在线](protocol.md#保持在线)
    * 4.1.2 [加入游戏](protocol.md#加入游戏)
    * 4.1.3 [聊天消息](protocol.md#聊天消息)
    * 4.1.4 [时间更新](protocol.md#时间更新)
    * 4.1.5 [实体装备](protocol.md#实体装备)
    * 4.1.6 [出生点](protocol.md#出生点)
    * 4.1.7 [更新生命值](protocol.md#更新生命值)
    * 4.1.8 [重生](protocol.md#重生)
    * 4.1.9 [玩家坐标和视点](protocol.md#玩家坐标和视点)
    * 4.1.10 [更换手持物品](protocol.md#更换手持物品)
    * 4.1.11 [床的使用](protocol.md#床的使用)
    * 4.1.12 [动作](protocol.md#动作)
    * 4.1.13 [生成玩家](protocol.md#生成玩家)
    * 4.1.14 [捡拾物品](protocol.md#捡拾物品)
    * 4.1.15 [生成对象](protocol.md#生成对象)
    * 4.1.16 [生成生物](protocol.md#生成生物)
    * 4.1.17 [生成画框](protocol.md#生成画框)
    * 4.1.18 [生成经验球](protocol.md#生成经验球)
    * 4.1.19 [实体速率](protocol.md#实体速率)
    * 4.1.20 [破坏实体](protocol.md#破坏实体)
    * 4.1.21 [实体](protocol.md#实体)
    * 4.1.22 [实体相对移动](protocol.md#实体相对移动)
    * 4.1.23 [实体视点](protocol.md#实体视点)
    * 4.1.24 [实体相对移动并且视点改变](protocol.md#实体相对移动并且视点改变)
    * 4.1.25 [实体传送](protocol.md#实体传送)
    * 4.1.26 [实体头部移动](protocol.md#实体头部移动)
    * 4.1.27 [实体状态](protocol.md#实体状态)
    * 4.1.28 [依附实体](protocol.md#依附实体)
    * 4.1.29 [实体元数据](protocol.md#实体元数据)
    * 4.1.30 [实体药水效果](protocol.md#实体药水效果)
    * 4.1.31 [移除实体药水效果](protocol.md#移除实体药水效果)
    * 4.1.32 [设置经验](protocol.md#设置经验)
    * 4.1.33 [实体设置](protocol.md#实体设置)
    * 4.1.34 [区块数据](protocol.md#区块数据)
    * 4.1.35 [多个方块更新](protocol.md#多个方块更新)
    * 4.1.36 [方块更新](protocol.md#方块更新)
    * 4.1.37 [方块表现](protocol.md#方块表现)
    * 4.1.38 [破坏方块动画](protocol.md#破坏方块动画)
    * 4.1.39 [地图区块传送](protocol.md#地图区块传送)
    * 4.1.40 [爆炸](protocol.md#爆炸)
    * 4.1.41 [效果](protocol.md#效果)
      * 4.1.41.1 [各种效果](protocol.md#各种效果)
    * 4.1.42 [音效](protocol.md#音效)
    * 4.1.43 [颗粒](protocol.md#颗粒)
    * 4.1.44 [修改游戏状态](protocol.md#修改游戏状态)
    * 4.1.45 [生成全局实体](protocol.md#生成全局实体)
    * 4.1.46 [打开窗口](protocol.md#打开窗口)
    * 4.1.47 [关闭窗口](protocol.md#关闭窗口)
    * 4.1.48 [栏位数据设置](protocol.md#栏位数据设置)
    * 4.1.49 [窗口物品](protocol.md#窗口物品)
    * 4.1.50 [窗口状态](protocol.md#窗口状态)
    * 4.1.51 [确认事务](protocol.md#确认事务)
    * 4.1.52 [更新牌子](protocol.md#更新牌子)
    * 4.1.53 [地图](protocol.md#地图)
    * 4.1.54 [更新方块实体](protocol.md#更新方块实体)
    * 4.1.55 [打开木牌编辑窗](protocol.md#打开木牌编辑窗)
    * 4.1.56 [统计信息](protocol.md#统计信息)
    * 4.1.57 [玩家列表](protocol.md#玩家列表)
    * 4.1.58 [玩家能力](protocol.md#玩家能力)
    * 4.1.59 [Tab补全](protocol.md#tab补全)
    * 4.1.60 [计分板容器](protocol.md#计分板容器)
    * 4.1.61 [更新积分](protocol.md#更新积分)
    * 4.1.62 [显示计分板](protocol.md#显示计分板)
    * 4.1.63 [队伍](protocol.md#队伍)
    * 4.1.64 [插件信息](protocol.md#插件信息)
    * 4.1.65 [断开连接](protocol.md#断开连接)
    * 4.1.66 [服务器难度](protocol.md#服务器难度)
    * 4.1.67 [格斗事件](protocol.md#格斗事件)
    * 4.1.68 [相机](protocol.md#相机)
    * 4.1.69 [世界边框](protocol.md#世界边框)
    * 4.1.70 [标题](protocol.md#标题)
    * 4.1.71 [设置压缩](protocol.md#设置压缩)
    * 4.1.72 [玩家列表首尾](protocol.md#玩家列表首尾)
    * 4.1.73 [发送资源包](protocol.md#发送资源包)
    * 4.1.74 [更新实体NBT](protocol.md#更新实体nbt)
  * 4.2 [服务端](protocol.md#服务端-1)
    * 4.2.1 [保持在线](protocol.md#保持在线-1)
    * 4.2.2 [聊天消息](protocol.md#聊天消息-1)
    * 4.2.3 [使用实体](protocol.md#使用实体)
    * 4.2.4 [玩家](protocol.md#玩家)
    * 4.2.5 [玩家坐标](protocol.md#玩家坐标)
    * 4.2.6 [玩家视点](protocol.md#玩家视点)
    * 4.2.7 [玩家坐标和视点](protocol.md#玩家坐标和视点-1)
    * 4.2.8 [玩家挖掘](protocol.md#玩家挖掘)
    * 4.2.9 [玩家放置方块](protocol.md#玩家放置方块)
    * 4.2.10 [持有物品改变](protocol.md#持有物品改变)
    * 4.2.11 [动画](protocol.md#动画)
    * 4.2.12 [实体表现](protocol.md#实体表现)
    * 4.2.13 [驾驶交通工具](protocol.md#驾驶交通工具)
    * 4.2.14 [关闭窗口](protocol.md#关闭窗口-1)
    * 4.2.15 [点击窗口](protocol.md#点击窗口)
    * 4.2.16 [确认事务](protocol.md#确认事务-1)
    * 4.2.17 [创造模式背包事件](protocol.md#创造模式背包事件)
    * 4.2.18 [附魔物品](protocol.md#附魔物品)
    * 4.2.19 [修改木牌](protocol.md#修改木牌)
    * 4.2.20 [玩家能力](protocol.md#玩家能力-1)
    * 4.2.21 [Tab补全](protocol.md#tab补全-1)
    * 4.2.22 [客户端设置](protocol.md#客户端设置)
    * 4.2.23 [客户端状态](protocol.md#客户端状态)
    * 4.2.24 [插件信息](protocol.md#插件信息-1)
    * 4.2.25 [观察者模式](protocol.md#观察者模式)
    * 4.2.26 [资源包状态](protocol.md#资源包状态)
* 5 [状态](protocol.md#状态)
  * 5.1 [客户端](protocol.md#客户端-1)
    * 5.1.1 [响应](protocol.md#响应)
    * 5.1.2 [Ping](protocol.md#ping)
  * 5.2 [服务端](protocol.md#服务端-2)
    * 5.2.1 [请求](protocol.md#请求)
    * 5.2.2 [Ping](protocol.md#ping-1)
* 6 [登录](protocol.md#登录)
  * 6.1 [客户端](protocol.md#客户端-2)
