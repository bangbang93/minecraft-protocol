...
* 2 [数据包格式](packetformat.md#数据包格式)
  * 2.1 [未压缩的封包](packetformat.md#未压缩的封包)
  * 2.2 [压缩的封包](packetformat.md#压缩的封包)
* 3 [握手](handshaking.md#握手)
  * 3.1 [服务端](handshaking.md#服务端)
    * 3.1.1 [握手](handshaking.md#握手-1)
* 4 [游戏中](clientboundplay.md)
  * 4.1 [客户端](clientboundplay.md#游戏中客户端)
    ...
    * 4.1.43 [颗粒](clientboundplay.md#颗粒)
    * 4.1.44 [修改游戏状态](clientboundplay.md#修改游戏状态)
    * 4.1.45 [生成全局实体](clientboundplay.md#生成全局实体)
    * 4.1.46 [打开窗口](clientboundplay.md#打开窗口)
    * 4.1.47 [关闭窗口](clientboundplay.md#关闭窗口)
    * 4.1.48 [栏位数据设置](clientboundplay.md#栏位数据设置)
    * 4.1.49 [窗口物品](clientboundplay.md#窗口物品)
    * 4.1.50 [窗口状态](clientboundplay.md#窗口状态)
    * 4.1.51 [确认事务](clientboundplay.md#确认事务)
    * 4.1.52 [更新牌子](clientboundplay.md#更新牌子)
    * 4.1.53 [地图](clientboundplay.md#地图)
    * 4.1.54 [更新方块实体](clientboundplay.md#更新方块实体)
    * 4.1.55 [打开木牌编辑窗](clientboundplay.md#打开木牌编辑窗)
    * 4.1.56 [统计信息](clientboundplay.md#统计信息)
    * 4.1.57 [玩家列表](clientboundplay.md#玩家列表)
    * 4.1.58 [玩家能力](clientboundplay.md#玩家能力)
    * 4.1.59 [Tab补全](clientboundplay.md#tab补全)
    * 4.1.60 [计分板容器](clientboundplay.md#计分板容器)
    * 4.1.61 [更新积分](clientboundplay.md#更新积分)
    * 4.1.62 [显示计分板](clientboundplay.md#显示计分板)
    * 4.1.63 [队伍](clientboundplay.md#队伍)
    * 4.1.64 [插件信息](clientboundplay.md#插件信息)
    * 4.1.65 [断开连接](clientboundplay.md#断开连接)
    * 4.1.66 [服务器难度](clientboundplay.md#服务器难度)
    * 4.1.67 [格斗事件](clientboundplay.md#格斗事件)
    * 4.1.68 [相机](clientboundplay.md#相机)
    * 4.1.69 [世界边框](clientboundplay.md#世界边框)
    * 4.1.70 [标题](clientboundplay.md#标题)
    * 4.1.71 [设置压缩](clientboundplay.md#设置压缩)
    * 4.1.72 [玩家列表首尾](clientboundplay.md#玩家列表首尾)
    * 4.1.73 [发送资源包](clientboundplay.md#发送资源包)
    * 4.1.74 [更新实体NBT](clientboundplay.md#更新实体nbt)
  * 4.2 [服务端](serverboundplay.md#游戏中服务端)
    * 4.2.1 [保持在线](serverboundplay.md#保持在线)
    * 4.2.2 [聊天消息](serverboundplay.md#聊天消息)
    * 4.2.3 [使用实体](serverboundplay.md#使用实体)
    * 4.2.4 [玩家](serverboundplay.md#玩家)
    * 4.2.5 [玩家坐标](serverboundplay.md#玩家坐标)
    * 4.2.6 [玩家视点](serverboundplay.md#玩家视点)
    * 4.2.7 [玩家坐标和视点](serverboundplay.md#玩家坐标和视点)
    * 4.2.8 [玩家挖掘](serverboundplay.md#玩家挖掘)
    * 4.2.9 [玩家放置方块](serverboundplay.md#玩家放置方块)
    * 4.2.10 [持有物品改变](serverboundplay.md#持有物品改变)
    * 4.2.11 [动画](serverboundplay.md#动画)
    * 4.2.12 [实体表现](serverboundplay.md#实体表现)
    * 4.2.13 [驾驶交通工具](serverboundplay.md#驾驶交通工具)
    * 4.2.14 [关闭窗口](serverboundplay.md#关闭窗口)
    * 4.2.15 [点击窗口](serverboundplay.md#点击窗口)
    * 4.2.16 [确认事务](serverboundplay.md#确认事务)
    * 4.2.17 [创造模式背包事件](serverboundplay.md#创造模式背包事件)
    * 4.2.18 [附魔物品](serverboundplay.md#附魔物品)
    * 4.2.19 [修改木牌](serverboundplay.md#修改木牌)
    * 4.2.20 [玩家能力](serverboundplay.md#玩家能力)
    * 4.2.21 [Tab补全](serverboundplay.md#tab补全)
    * 4.2.22 [客户端设置](serverboundplay.md#客户端设置)
    * 4.2.23 [客户端状态](serverboundplay.md#客户端状态)
    * 4.2.24 [插件信息](serverboundplay.md#插件信息)
    * 4.2.25 [观察者模式](serverboundplay.md#观察者模式)
    * 4.2.26 [资源包状态](serverboundplay.md#资源包状态)
* 5 [状态](status.md#状态)
  * 5.1 [客户端](status.md#客户端)
    * 5.1.1 [响应](status.md#响应)
    * 5.1.2 [Ping](status.md#ping)
  * 5.2 [服务端](status.md#服务端)
    * 5.2.1 [请求](status.md#请求)
    * 5.2.2 [Ping](status.md#ping-1)
* 6 [登录](login.md#登录)
  * 6.1 [客户端](login.md#客户端)
    * 6.1.1 [断开连接](login.md#断开连接)
    * 6.1.2 [请求加密](login.md#请求加密)
    * 6.1.3 [登录成功](login.md#登录成功)
    * 6.1.4 [设置压缩](login.md#启用压缩)
  * 6.2 [服务端](login.md#服务端)
    * 6.2.1 [开始登录](login.md#开始登录)
